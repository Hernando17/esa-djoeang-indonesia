      ...
      if (v >= t.minTranslate() && (v = t.minTranslate()), v <= t.maxTranslate() && (v = t.maxTranslate()), a = !!t.params.loop || !(v === t.minTranslate() || v === t.maxTranslate()), a && t.params.nested && s.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
        ...
        if (!_a20) {
          ...
          if (_n7 >= t.minTranslate() && (_n7 = t.minTranslate()), _n7 <= t.maxTranslate() && (_n7 = t.maxTranslate()), t.setTransition(0), t.setTranslate(_n7), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!_d5 && t.isBeginning || !_u2 && t.isEnd) && t.updateSlidesClasses(), t.params.freeMode.sticky) {
            ...
            l || (l = p(function () {
              o = _e53, h.splice(0), t.slideToClosest(t.params.speed, !0, void 0, 0.5);
            }, 500));
          }
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e85 = 0, _t57 = a.length; _e85 < _t57; _e85 += 1) {
          ...
          Math.abs(_v2) < 0.001 && (_v2 = 0), Math.abs(_g2) < 0.001 && (_g2 = 0), Math.abs(_m2) < 0.001 && (_m2 = 0), Math.abs(_u5) < 0.001 && (_u5 = 0), Math.abs(_h3) < 0.001 && (_h3 = 0), Math.abs(_w) < 0.001 && (_w = 0);
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _l10 = 0; _l10 < e.length; _l10 += 1) {
          ...
          if (_b2 || _x) {
            var _e89 = Math.pow(1 - Math.abs((Math.abs(_c6) - 0.5) / 0.5), 0.5);

            _g3 += -28 * _c6 * _e89, _f4 += -0.5 * _e89, _v3 += 96 * _e89, _h4 = -25 * _e89 * Math.abs(_c6) + "%";
          }
          ...
          if (a.slideShadows) {
            ...
            0 === _e91.length && (_e91 = ie(a, _o9)), _e91.length && (_e91[0].style.opacity = Math.min(Math.max((Math.abs(_c6) - 0.5) / 0.5, 0), 1));
          }
